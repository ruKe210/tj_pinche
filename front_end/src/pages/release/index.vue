<template>
  <view id="release">
    ...
    <view class="list" v-if="hasStaring">
          ...
          <movable-view out-of-bounds="true"
            ...
            <view class="content" @click="detail(item.travel.id)" hover-class="choose-hover">
              <view class="info">
                ...
                <view :class="[item.travel.type === '2' ? 'driver' : 'passenger', 'type']">
                  我是{{ item.travel.type === '2' ? '车主' : '乘客' }}
                </view>
              </view>
    ...
    methods: {
      ...
      getRelease (lastTime, type, pageNum, count) {
        getRelease(lastTime, type, pageNum, count).then(res => {
          ...
          if (res.meta && res.meta.code === 2000) {
